...
public class Listener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent event) {
		try {
			...
			String sql3 = "create table campusestock.product(productId varchar(200), vendorId varchar(200), productName varchar(200), productDescription varchar(500), productCondition varchar(200), datePosted date, productStatus varchar(200), productSample1 longBlob, prodcutSample2 longBlob, productSample3 longblob, adsStatus varchar(200), brandName varchar(200), keywords varchar(500), productAmount double)";
