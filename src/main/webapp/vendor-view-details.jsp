...
<body>
	...
	<%!String productID = "", productName = "", productCategory = "", productStatus = "", productDescription = "",
			productCondition = "", productImage1 = "", productImage2 = "", productImage3 = "", path = "";
						...
						<div class="product__details__pic">
							<div class="product__details__pic__item">
								<img class="product__details__pic__item--large"
									src="img/product/vendorDetails/<%=productImage1%>" alt="" />
							</div>
							<div class="product__details__pic__slider owl-carousel">
								...
								<img
									...
									src="img/product/vendorDetails/<%=productImage2%>" alt="" />
								<img
									data-imgbigurl="img/product/vendorDetails/<%=productImage3%>"
									src="img/product/vendorDetails/<%=productImage3%>" alt="" />
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-6">
